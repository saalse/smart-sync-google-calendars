/**
 * BatchRequest - Batch API Request Handler for Google Apps Script
 * 
 * Based on: https://github.com/tanaikech/BatchRequest
 * Author: tanaikech
 * License: MIT
 * 
 * Handles batching of Google Calendar API requests for efficient
 * bulk operations (create, update, delete events).
 */
